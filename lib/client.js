...
var SCHEDULE_TIMEZONE_PATTERN = /^[A-Za-z][A-Za-z0-9_+\-/]{0,63}$/;
function isValidTimezone(value) {
  if (value === LIMITS.systemTimezone || value === "UTC") return true;
  if (typeof value !== "string" || value.length === 0 || value.length > LIMITS.maxTimezoneLength) return false;
...
function normalizeSchedule(value) {
  ...
  const timezone = typeof value.timezone === "string" && value.timezone.trim() ? value.timezone.trim() : LIMITS.systemTimezone;
...
var Switch = React.memo(function Switch2({ on, onChange, disabled, label }) {
  return h(
    "button",
    {
      type: "button",
...
var Notice = React.memo(function Notice2({ notice, onDismiss }) {
...
var ConfirmDialog = React.memo(function ConfirmDialog2({ options, onClose }) {
  React.useEffect(() => {
    const onKey = (event) => {
...
var StatusCard = React.memo(function StatusCard2({ label, value, tone }) {
  return h(
    "div",
...
var ItemCard = React.memo(function ItemCard2({ item }) {
...
function OverviewPanel({ status }) {
  ...
  return [
    ...
    h(
      ...
      recent.length === 0 ? h("p", { className: "drss-empty" }, tr("\u6682\u65E0\u65B0\u6761\u76EE")) : h(
        "div",
        { className: "drss-twoCol" },
    ...
    h(
      ...
      history.length === 0 ? h("p", { className: "drss-empty" }, tr("\u6682\u65E0\u5386\u53F2\u8BB0\u5F55")) : h(
        "div",
        { className: "drss-twoCol" },
        history.map((entry, index) => h(
          "div",
...
var DAY_KEYS = ["\u5468\u65E5", "\u5468\u4E00", "\u5468\u4E8C", "\u5468\u4E09", "\u5468\u56DB", "\u5468\u4E94", "\u5468\u516D"];
...
function SettingsPanel({ status, busy, run, rpc, confirmAction }) {
  ...
  return [
    h(
      ...
      h(
        "section",
        { key: "schedule", className: "drss-schedule" },
        h("h3", { style: { margin: "0 0 10px", fontSize: 14 } }, tr("\u65F6\u95F4\u533A\u95F4")),
        h(
          "div",
          { className: "drss-scheduleBody" },
          h(
            "label",
            { className: "drss-scheduleRow" },
            h("input", {
              type: "checkbox",
          ...
          scheduleEnabled ? h(
            "div",
            { className: "drss-scheduleFields" },
            h(
              "fieldset",
              { className: "drss-scheduleDays" },
              h("legend", null, tr("\u661F\u671F")),
              DAY_KEYS.map((key, dayIndex) => h(
                "label",
                { key: dayIndex, className: "drss-scheduleDay" },
                h("input", {
                  type: "checkbox",
                  ...
                  onChange: (event) => {
                    updateDraft({
                      days: event.target.checked ? [...scheduleDays, dayIndex].sort((a, b) => a - b) : scheduleDays.filter((value) => value !== dayIndex)
                    });
                  }
                }),
                tr(key)
            ...
            h(
              "div",
              { className: "drss-scheduleTimeRow" },
              h(
                "label",
                null,
                h("span", null, tr("\u5F00\u59CB\u65F6\u95F4")),
          ...
          h(
            "div",
            { className: "drss-scheduleActions" },
            h("button", {
              type: "button",
              className: "drss-button drss-buttonPrimary",
              ...
              onClick: () => run(
                async () => {
                  await rpc(RSS_RPC_ENDPOINTS.settingsSave, {
...
function RssSettingsTab({ rpcCall, version: version2 = "0.2.10" }) {
