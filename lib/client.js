...
function SettingsPanel({ status, busy, run, rpc, confirmAction }) {
  ...
  const scheduleStatusLabel = !scheduleEnabled ? tr("\u65F6\u95F4\u533A\u95F4\u672A\u542F\u7528") : scheduleActive ? tr("\u5F53\u524D\u5728\u7A97\u53E3\u5185") : tr("\u5F53\u524D\u5728\u7A97\u53E3\u5916");
  return [
    h(
      "section",
      ...
      h(
        ...
        h(
          "summary",
          { className: "drss-scheduleSummary" },
          ...
          h("span", {
            className: scheduleActive && scheduleEnabled ? "drss-scheduleTag drss-scheduleTagInside" : "drss-scheduleTag"
          }, scheduleStatusLabel)
        ),
        h(
          "div",
